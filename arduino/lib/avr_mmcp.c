...
#define SELECT() 	SPI_CSL(CS_SD)
#define DESELECT() 	SPI_CSH(CS_SD)
#define SELECTING 	!(PORTB & (1<<PB3))
#define xmit(d) 	Serial_writeFlush(d)
#define FORWARD(d) 	xmit(d)
#define dly_100us()	delay_us(100)
#define init_spi()	SPI_Init(CS_SD)
#define xmit_spi(d)	SPI_Transmit(d)
#define	rcv_spi()	SPI_Rcv()
/*--------------------------------------------------------------------------
